 ...
 * @author Hari Prasad.
 */
public class AvastUpdateVirusDefinitionsAction extends AbstractAction {

    protected static final String DESCRIPTION = "Update Avast Database";
    ...
    public AvastUpdateVirusDefinitionsAction() {
        super("com.jscape.inet.mft.workflow.actions.repo.av.properties.AvastUpdateVirusDefinitionsHelp");
    }

    /**
     * Sets the program which is ran. It is required.
     *
     * @param value the path to Avast Update
     */
