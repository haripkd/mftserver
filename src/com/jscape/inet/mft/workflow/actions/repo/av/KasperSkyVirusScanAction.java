 ...
 * @author Hari Prasad.
 */
public class KasperSkyVirusScanAction extends AbstractAction {
    ...
    public KasperSkyVirusScanAction() {
        super("com.jscape.inet.mft.workflow.actions.repo.av.properties.KasperSkyVirusScanHelp");
    }

    /**
     * Sets the program which is ran. It is required.
     *
     * @param value the path to Kasper Sky Scan
     */
